...
$string['noactiverooms'] = 'Наразі активних кімнат немає.';
...
$string['preload_file'] = 'Файл презентації попереднього завантаження';
$string['preload_file_help'] = 'Дозволяє завантажити PDF або Office-документ, який автоматично завантажується на дошку на початку сесії. Це гарантує, що матеріал презентації буде готовий для заняття негайно. <strong>Максимальний розмір файлу: 5 Мб</strong>';
...
$string['event_recording_started'] = 'Початок запису';
$string['event_recording_ended'] = 'Завершення запису';
$string['event_rtmp_started'] = 'Початок трансляції RTMP';
$string['event_rtmp_ended'] = 'RTMP-стрім завершено';
