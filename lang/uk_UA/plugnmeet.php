...
$string['enable_dynacast_des'] = 'Використовуйте Dynacast для оптимізації відеопотоків, публікуючи лише найсвіжішого активного спікера.';
$string['enable_simulcast'] = 'Увімкнути симультанну трансляцію';
$string['enable_simulcast_des'] = 'Використовуйте Simulcast, щоб надати глядачам кілька шарів якості відео.';
$string['video_codec'] = 'Відеокодек';
$string['video_codec_des'] = 'Стандартний відеокодек для сесій.';
$string['default_webcam_resolution'] = 'Стандартна роздільна здатність вебкамери';
$string['default_webcam_resolution_des'] = 'Роздільна здатність вебкамер за замовчуванням.';
$string['default_screen_share_resolution'] = 'Стандартна роздільна здатність спільного екрану';
$string['default_screen_share_resolution_des'] = 'Стандартна роздільна здатність для спільного використання екрану.';
$string['default_audio_preset'] = 'Стандартний аудіопресет';
$string['default_audio_preset_des'] = 'Стандартний пресет аудіо для сесій.';

$string['branding'] = 'Брендинг і кастомізація';
$string['custom_logo'] = 'Індивідуальний логотип';
$string['custom_logo_des'] = 'Завантажте власний логотип для розміщення в конференц-залі. Якщо порожній, використовується стандартний логотип PlugNmeet.';
$string['custom_css_url'] = 'Користувацька URL-адреса CSS';
$string['custom_css_url_des'] = 'Вкажіть URL зовнішньому CSS-файлу, щоб налаштувати вигляд і атмосферу конференц-зали.';
$string['primary_color'] = 'Основний колір';
$string['primary_color_des'] = 'Основний колір для ґудзиків і підсвіток.';
$string['secondary_color'] = 'Вторинний колір';
$string['secondary_color_des'] = 'Вторинний колір елементів інтерфейсу.';
...
$string['copyright_text_des'] = 'Текст авторського права для розміщення у підніжжі зали для засідань. HTML дозволений.';
$string['client_load'] = 'Навантаження на клієнта від';
$string['client_load_des'] = 'за замовчуванням: локальне';
$string['remote'] = 'Віддаленого';
$string['local'] = 'Місцевий';

$string['client_side'] = 'Варіанти на стороні клієнта';
$string['client_load_mode'] = 'Режим завантаження клієнта';
$string['client_load_mode_desc'] = 'Оберіть, чи завантажувати веб-клієнт з віддаленого сервера, чи з локальної копії.';
$string['remote'] = 'Віддалений';
$string['local'] = 'Місцеві';
$string['client_download_url'] = 'URL завантаження клієнта';
$string['client_download_url_des'] = 'Якщо використовуєте режим завантаження «Local», вкажіть URL файлу client.zip.';
$string['update_client_btn'] = 'Оновити локальний клієнт';
$string['update_client_btn_label'] = 'Оновлення зараз';
...
$string['room_duration_help'] = 'Максимальна тривалість кімнати — хвилини. 0 — без обмежень.';
$string['moderator_join_first'] = 'Модератор Приєднуйся першим';
$string['moderator_join_first_help'] = 'Вимагайте, щоб модератор приєднався раніше, ніж інші учасники.';
$string['enable_analytics'] = 'Увімкнути аналітику';
$string['enable_analytics_help'] = 'Генеруйте аналітику для сесії.';
...
$string['auto_gen_user_id_help'] = 'Автоматично згенеруйте ідентифікатор користувача для кожного учасника.';
...
$string['is_allow_view_recording'] = 'Дозволити перегляд записів';
$string['is_allow_view_recording_help'] = 'Дозвольте учасникам переглядати записи.';
$string['is_allow_download_recording'] = 'Дозволити завантаження записів';
$string['is_allow_download_recording_help'] = 'Дозвольте учасникам завантажувати записи.';
...
// Notifications
$string['messageprovider:recording_artifact_notifications'] = 'Сповіщення про готові записи та артефакти';
