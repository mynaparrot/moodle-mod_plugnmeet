...
$string['video_codec_des'] = 'Lo standard di codifica per la trasmissione video. **VP9** è lo standard predefinito e raccomandato per WebRTC, offrendo un equilibrio superiore tra qualità video, efficienza CPU e bassa latenza (che torna automaticamente a **VP8** nei browser più vecchi). **Attenzione:** I codec avanzati come AV1 o H.265 richiedono il supporto moderno dei browser; Assicurati che i tuoi utenti siano su configurazioni compatibili se devi dal valore predefinito.';
...
$string['allow_reactions'] = 'Permettere le reazioni';
$string['allow_reactions_help'] = 'Permette ai partecipanti di inviare reazioni fluttuanti (ad esempio, pollice in su, applausi) durante la sessione.';
...
$string['lock_reactions'] = 'Reazioni di blocco';
$string['lock_reactions_help'] = 'Impedisce ai partecipanti di inviare qualsiasi reazione durante la sessione.';
...
$string['analytics_room_shared_notepad_status'] = 'Conteggio dello stato del blocco note';
...
$string['poll_mode'] = 'Modalità sondaggio';
$string['poll_mode_quiz'] = 'Quiz (mostra la risposta corretta dopo il sondaggio)';
$string['poll_mode_vote'] = 'Vota (raccogli solo risposte)';
$string['poll_mode_help'] = 'In modalità quiz, i partecipanti vedono la risposta corretta dopo la fine del sondaggio. In modalità voto, non viene mostrata alcuna risposta corretta.';
$string['poll_duration'] = 'Chiusura automatica dopo (minuti)';
$string['poll_duration_help'] = 'Massimo 60 minuti consentiti. 0 = nessun limite';
...
$string['no_categories_found'] = 'Categorie senza domande trovate';
$string['invalid_question_category'] = 'La categoria di domande non esiste o non può essere utilizzata come fonte di sondaggio per questa attività.';
