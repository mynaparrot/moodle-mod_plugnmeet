...
$string['room_duration_help'] = 'La durée maximale de la pièce en quelques minutes. 0 pour sans limite.';
...
$string['enable_analytics_help'] = 'Générez des analyses pour la session.';
...
$string['auto_gen_user_id_help'] = 'Générez automatiquement un identifiant utilisateur pour chaque participant.';
...
// Notifications
$string['messageprovider:recording_artifact_notifications'] = 'Notifications pour les enregistrements et artefacts prêts à être';
