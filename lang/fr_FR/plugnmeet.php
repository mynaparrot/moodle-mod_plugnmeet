...
$string['enable_end_to_end_encryption_features_help'] = 'Assure une sécurité solide en chiffreant les flux vidéo et audio entre les participants. Dans ce mode, le serveur génère et distribue en toute sécurité une clé de chiffrement unique pour la session.';
$string['enabled_self_insert_encryption_key'] = 'Autoriser les clés définies par les participants';
$string['enabled_self_insert_encryption_key_help'] = 'Permet aux participants de saisir manuellement une clé secrète partagée, offrant le plus haut niveau de confidentialité puisque le serveur n’a jamais accès aux clés de chiffrement. Il est de la responsabilité de l’hôte de partager le même secret avec tous les participants ; Si différentes clés sont utilisées, les utilisateurs ne pourront pas communiquer entre eux. <strong>Note :</strong> Lorsque cette option est activée, les fonctionnalités nécessitant un traitement des médias côté serveur (comme l’enregistrement cloud, la transcription et la synthèse IA) sont automatiquement désactivées.';
...
$string['client_files_missing'] = 'Les fichiers clients (JS/CSS) manquent. Veuillez vérifier la configuration de votre serveur PlugNetet.';
$string['client_connection_error'] = 'Il y a eu une erreur de connexion au serveur PlugNmeet : {$a}. Veuillez vérifier les paramètres de votre plugin.';
...
$string['error_loading_meeting_summary'] = 'Résumé de la réunion de chargement des erreurs : {$a}';
