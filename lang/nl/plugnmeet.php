...
$string['subplugintype_pnmext'] = 'PlugNmeet-uitbreiding';
$string['subplugintype_pnmext_plural'] = 'PlugNmeet-extensies';
...
$string['video_codec_des'] = 'De coderingsstandaard voor videotransmissie. **VP9** is de standaard en aanbevolen standaard voor WebRTC, met een superieure balans tussen videokwaliteit, CPU-efficiëntie en lage latentie (automatisch terugvallend op **VP8** bij oudere browsers). **Waarschuwing:** Geavanceerde codecs zoals AV1 of H.265 vereisen moderne browserondersteuning; Zorg ervoor dat je gebruikers compatibele setups hebben als je afwijkt van de standaardinstelling.';
...
$string['recording_broadcasting_features'] = 'Opname en uitzending';
...
$string['allow_broadcasting'] = 'Uitzendingen toestaan (Master Switch)';
$string['allow_broadcasting_help'] = 'De primaire hoofdschakelaar voor alle uitzendfuncties. Als deze wordt uitgeschakeld, worden alle andere uitzendopties uitgeschakeld.';
...
$string['allow_reactions'] = 'Reacties toestaan';
$string['allow_reactions_help'] = 'Laat deelnemers tijdens de sessie zwevende reacties sturen (bijvoorbeeld duim omhoog, klappen).';
...
$string['only_record_admin_webcams'] = 'Alleen Record Admin-webcams';
$string['only_record_admin_webcams_help'] = 'Als ingeschakeld, worden alleen de webcams van beheerders opgenomen in de opname.';
...
$string['lock_reactions'] = 'Slotreacties';
$string['lock_reactions_help'] = 'Voorkomt dat deelnemers tijdens de sessie reacties sturen.';
...
$string['status_conflict'] = 'Deze actie kon niet worden uitgevoerd vanwege een conflict (bijvoorbeeld hetzelfde verzoek herhaald).';
...
$string['merge_recordings'] = 'Samenvoegen van opnames';
$string['merged_file_name'] = 'Samengevoegde bestandsnaam';
$string['merge'] = 'Fuseren';
$string['close'] = 'Sluit';
$string['merge_confirmation'] = 'Weet je zeker dat je de geselecteerde opnames wilt samenvoegen?';
$string['modal_merge_recordings_header'] = 'De volgende opnames worden in deze volgorde samengevoegd:';
$string['modal_merge_recordings_prompt'] = 'Je moet minstens twee opnames selecteren om te samenvoegen.';
$string['merge_request_success'] = 'Het verzoek om opnames te meren is succesvol toegevoegd. Je krijgt een melding zodra het voltooid is.';
$string['upload_to_whiteboard'] = 'Upload naar whiteboard';
$string['upload_to_whiteboard_success'] = 'Geselecteerd bestand succesvol geüpload naar het whiteboard';
...
$string['poll_mode'] = 'Peilmodus';
$string['poll_mode_quiz'] = 'Quiz (toon het juiste antwoord na de poll)';
$string['poll_mode_vote'] = 'Stem (alleen reacties verzamelen)';
$string['poll_mode_help'] = 'In quizmodus zien deelnemers het juiste antwoord nadat de poll is afgelopen. In de stemmodus wordt geen correct antwoord getoond.';
$string['poll_duration'] = 'Automatisch sluiten na (minuten)';
$string['poll_duration_help'] = 'Maximaal 60 minuten toegestaan. 0 = geen limiet';
