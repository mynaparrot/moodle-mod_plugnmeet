...
$string['video_codec_des'] = 'معيار الترميز لنقل الفيديو. **VP9** هو المعيار الافتراضي والموصى به ل WebRTC، حيث يوفر توازنا متميزا بين جودة الفيديو، وكفاءة المعالج، وانخفاض التأخير (يعود تلقائيا إلى **VP8** في المتصفحات القديمة). **تحذير:** الترميزات المتقدمة مثل AV1 أو H.265 تتطلب دعم متصفح حديث؛ تأكد من أن المستخدمين على إعدادات متوافقة إذا انحرفت عن الإعدادات الافتراضية.';
...
$string['allow_reactions'] = 'السماح بردود الفعل';
$string['allow_reactions_help'] = 'السماح للمشاركين بإرسال ردود فعل عائمة (مثل رفع الإبهام، التصفيق) خلال الجلسة.';
...
$string['lock_reactions'] = 'ردود فعل الأقفال';
$string['lock_reactions_help'] = 'يمنع المشاركين من إرسال أي ردود فعل أثناء الجلسة.';
...
$string['status_conflict'] = 'لم يكن بالإمكان إكمال هذا الإجراء بسبب وجود تعارض (مثل تكرار نفس الطلب).';
...
$string['merge_recordings'] = 'تسجيلات الدمج';
$string['merged_file_name'] = 'اسم الملف المدمج';
$string['merge'] = 'الاندماج';
$string['close'] = 'إغلاق';
$string['merge_confirmation'] = 'هل أنت متأكد أنك تريد دمج التسجيلات المختارة؟';
$string['modal_merge_recordings_header'] = 'سيتم دمج التسجيلات التالية بهذا الترتيب:';
$string['modal_merge_recordings_prompt'] = 'يجب عليك اختيار تسجيلين على الأقل للدمج.';
$string['merge_request_success'] = 'تمت إضافة طلب دمج التسجيلات بنجاح. سيتم إبلاغك عند اكتمالها.';
$string['upload_to_whiteboard'] = 'رفع الملف إلى السبورة البيضاء';
$string['upload_to_whiteboard_success'] = 'تم رفع ملف محدد بنجاح إلى السبورة البيضاء';
...
$string['poll_mode'] = 'وضع التصويت';
$string['poll_mode_quiz'] = 'اختبار (عرض الإجابة الصحيحة بعد الاستطلاع)';
$string['poll_mode_vote'] = 'صوت (اجمع الردود فقط)';
$string['poll_mode_help'] = 'في وضع الاختبار، يرى المشاركون الإجابة الصحيحة بعد انتهاء الاستطلاع. في وضع التصويت، لا يتم عرض إجابة صحيحة.';
$string['poll_duration'] = 'الإغلاق التلقائي بعد (دقائق)';
$string['poll_duration_help'] = 'الحد الأقصى مسموح به 60 دقيقة. 0 = لا حد';
