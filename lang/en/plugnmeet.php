...
$string['subplugintype_pnmext'] = 'PlugNmeet extension';
$string['subplugintype_pnmext_plural'] = 'PlugNmeet extensions';
...
$string['video_codec_des'] = 'The encoding standard for video transmission. **VP9** is the default and recommended standard for WebRTC, offering a superior balance of video quality, CPU efficiency, and low latency (automatically falling back to **VP8** on older browsers). **Warning:** Advanced codecs like AV1 or H.265 require modern browser support; ensure your users are on compatible setups if you deviate from the default.';
...
$string['recording_broadcasting_features'] = 'Recording and Broadcasting';
...
$string['allow_broadcasting'] = 'Allow Broadcasting (Master Switch)';
$string['allow_broadcasting_help'] = 'The primary master switch for all broadcasting features. If disabled, all other broadcasting options will be disabled.';
...
$string['only_record_admin_webcams'] = 'Only Record Admin Webcams';
$string['only_record_admin_webcams_help'] = 'If enabled, only the webcams of administrators will be included in the recording.';
...
$string['client_connection_error'] = 'There was an error connecting to the PlugNmeet server: {$a}. Please check your plugin settings.';
...
$string['status_conflict'] = 'This action could not be completed because of a conflict (e.g., same request repeated).';
...
$string['merged_file_name'] = 'Merged File Name';
$string['merge'] = 'Merge';
$string['close'] = 'Close';
$string['merge_confirmation'] = 'Are you sure you want to merge the selected recordings?';
$string['modal_merge_recordings_header'] = 'The following recordings will be merged in this order:';
$string['modal_merge_recordings_prompt'] = 'You must select at least two recordings to merge.';
$string['merge_request_success'] = 'Recordings merge request has been successfully added. You will be notified when it is complete.';
$string['upload_to_whiteboard'] = 'Upload to Whiteboard';
$string['upload_to_whiteboard_success'] = 'Successfully uploaded selected file to the whiteboard';
...
$string['poll_mode'] = 'Poll mode';
$string['poll_mode_quiz'] = 'Quiz (show correct answer after poll)';
$string['poll_mode_vote'] = 'Vote (collect responses only)';
$string['poll_mode_help'] = 'In quiz mode, participants see the correct answer after the poll ends. In vote mode, no correct answer is shown.';
$string['poll_duration'] = 'Auto-close after (minutes)';
$string['poll_duration_help'] = 'Maximum 60 minutes allowed. 0 = no limit';
