...
$string['server_url_desc'] = '你 PlugNmeet 服务器的基础网址（例如 https://pnm.example.com）。';
$string['api_key'] = 'API 密钥';
$string['api_key_desc'] = '你的PlugMeet服务器提供的独特API密钥。';
$string['api_secret'] = 'API 秘密';
$string['api_secret_desc'] = '你的 PlugNmeet 服务器提供的 API 秘密用于安全认证。';
$string['guest_access_hdr'] = '访客访问设置';
$string['allow_guest_global'] = '允许访客全球访问';
$string['allow_guest_global_desc'] = '作为主开关。如果禁用，教师在创建或编辑活动时将无法看到启用访客加入的选项。';
$string['guest_link_expiration'] = '访客链接过期时间（小时）';
$string['guest_link_expiration_desc'] = '确定教师生成访客访问链接后，该链接仍保持有效时间。';
$string['defaults'] = '技术默认设置';
$string['defaults_desc'] = '默认的技术配置应用到每个新的 PlugNmeet 会话。';
$string['enable_dynacast'] = '启用Dynacast';
$string['enable_dynacast_des'] = '通过动态暂停未被参与者观看的视频图层来优化性能。这大大降低了服务器端的CPU和带宽使用。**注意：** 如果使用SVC编解码器（VP9/AV1），此功能会自动启用，且多编解码器同步播出时是必需的。';
$string['enable_simulcast'] = '启用同步广播';
$string['enable_simulcast_des'] = '提供多层视频质量，确保连接较弱的用户体验流畅。';
$string['video_codec'] = '视频编解码器';
$string['video_codec_des'] = '视频传输的编码标准。**VP8**推荐用于WebRTC，因为它在质量和低延迟之间提供了最佳平衡。**警告：** 并非所有浏览器都支持所有编解码器;如果使用VP9或H.265，确保用户使用的是现代浏览器。';
$string['default_webcam_resolution'] = '默认摄像头分辨率';
$string['default_webcam_resolution_des'] = '参与式摄像头的初始分辨率设置。';
...
$string['default_audio_preset_des'] = '音频质量配置文件为会话优化。';

$string['branding'] = '品牌塑造与定制化';
$string['custom_logo'] = '定制标志';
$string['custom_logo_des'] = '把你的标志上传到会议室。如果留空，则使用默认的 PlugNmeet 标志。';
$string['custom_css_url'] = '自定义 CSS URL';
$string['custom_css_url_des'] = '链接外部.css文件以覆盖或自定义界面样式。';
$string['primary_color'] = '原色';
$string['primary_color_des'] = '按钮、激活状态和高光的主要点缀色。';
$string['secondary_color'] = '辅助颜色';
$string['secondary_color_des'] = '用于辅助UI元素的点缀色。';
$string['background_color'] = '背景颜色';
$string['background_color_des'] = '界面的主背景色。';
$string['background_image'] = '背景图片';
$string['background_image_des'] = '背景壁纸。为了获得最佳效果，使用1920x1080的图片。';
$string['header_color'] = '标题颜色';
$string['header_color_des'] = '顶部导航栏的背景色。';
$string['footer_color'] = '页脚颜色';
$string['footer_color_des'] = '底部工具栏的背景色。';
$string['left_color'] = '左侧颜色';
$string['left_color_des'] = '左侧导航侧边栏的背景色。';
$string['side_panel_bg_color'] = '侧面板背景色';
$string['side_panel_bg_color_des'] = '右侧面板的背景色（聊天和参与者列表）。';
$string['copyright_text'] = '版权文本';
$string['copyright_text_des'] = '品牌文字显示在设置页脚中。支持HTML用于链接或自定义样式。';
$string['client_load'] = '客户端加载方法';
$string['client_load_des'] = '选择**远程**（推荐），享受无缝且品牌化的体验，直接嵌入您的moodle页面。选择**重定向**以使用默认的plugNmeet接口;请注意，用户会离开您的网站，定制品牌可能不适用。';
...
$string['roomtitle_help'] = '这是Moodle活动和实时会议标题所用的名称。它帮助学生识别课程中和教室内的会话。';
...
$string['available'] = '可从';
$string['available_help'] = '决定参与者何时可以开始加入课程。用户在此日期和时间之前无法进入房间。';
$string['deadline'] = '可持续使用至此';
$string['deadline_help'] = '确定参与者可访问该课程的最终日期和时间。截止日期过后，访问权限将被阻止。';
...
$string['allow_rtmp_help'] = '允许版主将直播会话直播到YouTube、Facebook或Twitch等外部平台。非常适合公开网络研讨会或嘉宾讲座。';
...
$string['enable_analytics_help'] = '跟踪本次会议的参与和参与度数据。**注意：** 如果设置了任何完成标准，必须启用此功能。';
$string['allow_virtual_bg'] = '允许虚拟背景';
$string['allow_virtual_bg_help'] = '使参与者能够模糊背景或使用虚拟图像。非常适合维护学生隐私，确保课堂呈现专业。';
...
$string['allow_recording'] = '允许录制（主交换机）';
$string['allow_recording_help'] = '所有录音功能的主控开关。如果被禁用，云端和本地录制选项都会对版主隐藏。';
$string['allow_cloud_recording'] = '允许云端录制';
$string['allow_cloud_recording_help'] = '启用PlugNmeet服务器的录制。最终视频会被处理并存储在云端，会议结束后通过链接分享变得非常方便。';
$string['enable_auto_cloud_recording'] = '启用自动云记录';
$string['enable_auto_cloud_recording_help'] = '当第一个主持人加入会话时，会自动触发云端录制。这非常适合确保没有讲座被遗忘。';
$string['allow_local_recording'] = '允许本地录制';
$string['allow_local_recording_help'] = '允许直接录制到电脑。**注：** 需要Google Chrome。要捕获所有会话音频，用户必须分享“Chrome 标签页”并勾选“另共享标签页音频”选项。完成后，文件会保存到设备本地。';

$string['allow_chat'] = '允许聊天（全局主交换机）';
$string['allow_chat_help'] = '所有聊天功能的绝对主开关。如果禁用，整个聊天区将被移除，所有人包括版主。无法进行公开或私下聊天。';
$string['allow_file_upload'] = '允许上传文件';
$string['allow_file_upload_help'] = '支持在聊天中共享文件的功能。这需要“允许聊天”主交换机处于激活状态。';

$string['allow_shared_notepad'] = '允许共享记事本';
$string['allow_shared_notepad_help'] = '支持协作文本编辑器，学生和教师可以实时做笔记。这非常适合头脑风暴、合写或创建共享课程总结。';

$string['whiteboard_features'] = '白板功能';
$string['allow_whiteboard'] = '允许白板';
$string['allow_whiteboard_help'] = '为本次会面解锁一个互动绘画空间。用它来绘制图表、视觉化解题，或让学生为共享内容做注释。';
$string['preload_file'] = '预加载演示文件';
$string['preload_file_help'] = '允许你上传PDF或Office文档，课程开始时会自动加载到白板上。这确保你的演示材料能立即准备好用于课堂。 <strong>最大文件大小：5Mb</strong>';

$string['allowed_external_media_player'] = '允许外部媒体播放器';
$string['allowed_external_media_player_help'] = '允许版主同步并播放来自YouTube或Vimeo等来源的视频，供全班使用。非常适合分析教育片段或一起观看纪录片，且不会有带宽延迟。';
...
$string['allow_breakout_rooms_help'] = '允许版主将参与者分成更小的小组，进行专注讨论、协作项目或私人小组活动。';
$string['allowed_number_rooms'] = 'Max分组讨论室';
$string['allowed_number_rooms_help'] = '主持人在单场次内最多可创建的子房间数量。';

$string['allow_display_external_link_features'] = '允许外部链接共享';
$string['allow_display_external_link_features_help'] = '允许主持人在场次中直接向所有参与者展示外部教育内容，如H5P活动、SCORM包或测验系统（如Kahoot）。';

$string['allow_ingress_features'] = '允许进入（外部流媒体）';
$string['allow_ingress_features_help'] = '允许教师通过RTMP或WHIP协议，使用外部软件如OBS向课程中广播高质量视频。这非常适合分享高分辨率视频内容、预录会话，或绕过浏览器上传限制。';

$string['allow_polls'] = '允许投票';
$string['allow_polls_help'] = '允许版主在会话期间创建互动投票和快速测验。这是检查学生理解度并提高参与度的好方法。';

$string['sip_dial_in_features_is_allow'] = '允许SIP拨号';
$string['sip_dial_in_features_is_allow_help'] = '允许参与者通过传统电话加入音频会话。这对于网络连接较差或需要在外出时加入的学生来说尤为重要。';

$string['enable_end_to_end_encryption_features'] = '启用端到端加密（E2EE）';
$string['enable_end_to_end_encryption_features_help'] = '通过加密视频和音频流，确保连服务器都无法访问。注意：当端对端加密（E2EE）激活时，服务器端录制等功能可能会受到限制。';
$string['enabled_self_insert_encryption_key'] = '允许参与者定义密钥';
$string['enabled_self_insert_encryption_key_help'] = '允许参与者手动输入共享的密钥。这确保服务提供商永远无法接触加密密钥，提供最高级别的隐私保护。';
$string['included_e2ee_chat_messages'] = '加密聊天消息';
$string['included_e2ee_chat_messages_help'] = '将端到端加密扩展到文本聊天，确保消息只有在场参与者能阅读。';
$string['included_e2ee_whiteboard'] = '加密白板数据';
$string['included_e2ee_whiteboard_help'] = '包含所有白板图纸和注释，采用端到端加密层，保障全面数据隐私。';

$string['insights_features_is_allow'] = '允许会话洞察（主交换机）';
$string['insights_features_is_allow_help'] = '所有数据驱动功能的主交换机。如果禁用，所有子选项——包括转录、AI助手和会议报告——将完全无法使用。';
$string['insights_transcription_features_is_allow'] = '允许实时转录';
$string['insights_transcription_features_is_allow_help'] = '在会话中实现实时语音转文字。必须启用该功能，转录翻译或语音合成（TTS）才能正常工作。';
$string['insights_transcription_features_is_allow_translation'] = '允许转录翻译';
$string['insights_transcription_features_is_allow_translation_help'] = '允许实时转录稿翻译成多种语言，支持国际学生和多语言环境。';
$string['insights_transcription_features_is_allow_speech_synthesis'] = '允许语音合成（TTS）';
$string['insights_transcription_features_is_allow_speech_synthesis_help'] = '支持文字转语音，允许实时文字稿被朗读，以提高无障碍性和视障参与者的需求。';
$string['insights_chat_translation_features_is_allow'] = '允许聊天翻译';
$string['insights_chat_translation_features_is_allow_help'] = '支持聊天消息的实时翻译，使参与者能够即时跨语言交流。';
$string['insights_ai_features_is_allow'] = '允许AI会议助理（AI主开关）';
$string['insights_ai_features_is_allow_help'] = '所有AI驱动功能的主开关。如果禁用，像AI聊天和会议摘要这样的特定功能将被隐藏，即使会话洞察处于激活状态。';
$string['insights_ai_text_chat_features_is_allow'] = '允许AI聊天助手';
$string['insights_ai_text_chat_features_is_allow_help'] = '将AI助手直接集成到聊天中，帮助解答问题、解释复杂概念并促进小组讨论。';
$string['insights_ai_meeting_summarization_features_is_allow'] = '允许AI会议摘要';
$string['insights_ai_meeting_summarization_features_is_allow_help'] = '会话结束后自动生成简明的AI摘要，突出关键教育点、决策及后续任务。';

$string['lock_microphone'] = '锁定麦克风';
$string['lock_microphone_help'] = '进入时默认静音所有参与者。只有版主可以解除静音或允许发言。';
$string['lock_webcam'] = '锁定摄像头';
$string['lock_webcam_help'] = '默认禁用所有参与者的摄像头。这对节省带宽或保障学生隐私非常有用。';
$string['lock_screen_sharing'] = '锁屏共享';
$string['lock_screen_sharing_help'] = '仅限版主使用屏幕共享。防止参与者用自己的屏幕打断。';
$string['lock_whiteboard'] = '锁白板';
$string['lock_whiteboard_help'] = '限制白板绘图工具仅限版主使用。防止参与者未经授权的注释。';
$string['lock_shared_notepad'] = 'Lock 共享记事本';
$string['lock_shared_notepad_help'] = '禁用参与者的协作笔记本功能，以防止偏题写作或分心。';
$string['lock_chat'] = '锁定公共聊天';
$string['lock_chat_help'] = '完全隐藏或禁用所有参与者的公共聊天区。';
$string['lock_chat_send_message'] = '锁发送消息';
$string['lock_chat_send_message_help'] = '允许参与者阅读聊天内容，但禁止发送任何消息。';
$string['lock_chat_file_share'] = '锁文件共享';
$string['lock_chat_file_share_help'] = '防止参与者在聊天区上传或分享文件。';
$string['lock_private_chat'] = '锁定私人聊天';
$string['lock_private_chat_help'] = '禁用参与者之间的一对一私信。注意：参与者仍可私信版主寻求帮助或提问。';
