...
$string['room_duration_help'] = '房间最长持续时间为几分钟。0分代表无上限。';
$string['moderator_join_first'] = '版主：先加入';
$string['moderator_join_first_help'] = '要求版主先加入，其他参与者才能加入。';
$string['enable_analytics'] = '启用分析';
$string['enable_analytics_help'] = '生成会话中的分析数据。';
$string['allow_virtual_bg'] = '允许虚拟背景';
$string['allow_virtual_bg_help'] = '允许参与者使用虚拟背景。';
$string['auto_gen_user_id'] = '自动生成用户ID';
$string['auto_gen_user_id_help'] = '自动为每个参与者生成用户ID。';
...
// Notifications
$string['messageprovider:recording_artifact_notifications'] = '已准备好录音和伪影的通知';
