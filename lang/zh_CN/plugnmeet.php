...
$string['sip_dial_in_features'] = "SIP/VoIP 拨号输入功能";
$string['sip_dial_in_features_is_allow'] = "允许SIP/VoIP拨入";
$string['enable_dial_in_on_create'] = "在创建时启用拨入";
$string['hide_phone_number'] = "隐藏电话号码";
