...
$string['video_codec_des'] = 'El estándar de codificación para la transmisión de vídeo. **VP9** es el estándar por defecto y recomendado para WebRTC, ofreciendo un equilibrio superior entre calidad de vídeo, eficiencia de CPU y baja latencia (que automáticamente vuelve a **VP8** en navegadores antiguos). **Advertencia:** Los códecs avanzados como AV1 o H.265 requieren soporte moderno para navegadores; Asegúrate de que tus usuarios estén en configuraciones compatibles si te desvías de la predeterminada.';
