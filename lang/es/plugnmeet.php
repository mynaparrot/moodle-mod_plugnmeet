...
$string['preassign_breakout_rooms'] = 'Preasigna salas de grupo de grupos de cursos';
$string['preassign_breakout_rooms_help'] = 'Cuando se habilita, cada grupo de curso se convierte en una sala de grupos cuando comienza la sesión: el título de la sala es el nombre del grupo y los miembros del grupo se asignan automáticamente a él. El moderador puede reorganizar o eliminar estas asignaciones en cualquier momento en la gestión de la sala de grupos de la reunión. Los usuarios que no estén en ningún grupo pueden ser asignados por el moderador durante la sesión. Esto entra en vigor desde el inicio de la siguiente sesión, porque los detalles de la sala se fijan cuando se crea la sala. Requiere que el curso tenga grupos.';
...
$string['create_poll_from_quiz'] = 'Añadir encuesta desde Quiz';
$string['create_poll'] = 'Create Poll';
$string['select_quiz'] = 'Quiz selecto';
$string['select_question'] = 'Pregunta selectiva';
$string['poll_created'] = 'Encuesta creada con éxito';
$string['poll_creation_failed'] = 'No se creó una encuesta: {$a}';
$string['no_valid_questions'] = 'Este cuestionario no tiene preguntas válidas (solo se admiten preguntas de opción múltiple de respuesta única y verdadero/falso)';
$string['poll_is_anonymous'] = 'Votación anónima';
$string['poll_mode'] = 'Modo de encuesta';
$string['poll_mode_quiz'] = 'Quiz (muestra la respuesta correcta tras la encuesta)';
$string['poll_mode_vote'] = 'Vota (solo recoge respuestas)';
$string['poll_mode_help'] = 'En modo pregunta, los participantes ven la respuesta correcta tras finalizar la encuesta. En el modo votación, no se muestra ninguna respuesta correcta.';
...
$string['room_not_active'] = 'El espacio debe estar activo para crear encuestas';
$string['polls_not_allowed'] = 'No hay urnas activadas para esta sala';
$string['poll_invalid_question'] = 'La pregunta seleccionada no puede convertirse en una encuesta.';
...
$string['select_source'] = 'Fuente seleccionada';
