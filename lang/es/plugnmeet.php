...
$string['plugnmeetname'] = 'Ejemplo de nombre personalizado';
$string['plugnmeetname_help'] = 'Ejemplo de ayuda personalizada';
...
$string['allow_guest_global_desc'] = 'Actúa como un interruptor principal. Si está deshabilitado, los profesores no verán la opción para permitir el acceso de invitados al crear o editar actividades.';
...
$string['enable_dynacast_des'] = 'Optimiza el rendimiento al pausar dinámicamente las capas de video que los participantes no están visualizando. Esto reduce notablemente el uso de CPU y ancho de banda del servidor. **Nota:** Esto se habilitará automáticamente si se utilizan códecs SVC (VP9/AV1) y es necesario para la transmisión simultánea de múltiples códecs.';
$string['enable_simulcast'] = 'Habilitar Simulcast';
$string['enable_simulcast_des'] = 'Ofrece múltiples niveles de calidad de video para mantener una experiencia fluida a los usuarios con conexiones débiles.';
$string['video_codec'] = 'Códec de video';
$string['video_codec_des'] = 'El estándar de codificación para la transmisión de vídeo. **VP9** es el estándar por defecto y recomendado para WebRTC, ofreciendo un equilibrio superior entre calidad de vídeo, eficiencia de CPU y baja latencia (que automáticamente vuelve a **VP8** en navegadores antiguos). **Advertencia:** Los códecs avanzados, como AV1 o H.265, requieren navegadores compatibles. Verifique que los usuarios dispongan de un entorno compatible si se cambia la configuración predeterminada.';
$string['default_webcam_resolution'] = 'Resolución predeterminada de la cámara web';
$string['default_webcam_resolution_des'] = 'La resolución inicial configurada para las cámaras de los participantes.';
...
$string['default_audio_preset'] = 'Ajuste de audio por defecto';
...
$string['custom_css_url_des'] = 'Vincule un archivo .css externo para sobrescribir o personalizar los estilos de la interfaz.';
...
$string['artifacts'] = "Objetos de la sala";
...
$string['allow_reactions'] = 'Permitir reacciones';
$string['allow_reactions_help'] = 'Permite a los participantes enviar reacciones flotantes (por ejemplo, pulgar arriba, aplausos) durante la sesión.';
...
$string['enable_analytics_help'] = 'Rastrea los datos de participación e interacción de la sesión. **Nota:** Esto debe estar habilitado si se establecen criterios de finalización.';
...
$string['allow_recording_help'] = 'El interruptor principal para todas las funciones de grabación. Si está deshabilitado, las opciones de grabación en la nube y local estarán ocultas para los moderadores.';
...
$string['allow_local_recording_help'] = 'Permite grabar directamente en la computadora. **Nota:** Requiere Google Chrome. Para capturar todo el audio de la sesión, el usuario debe compartir su "Pestaña de Chrome" y marcar la casilla "También compartir audio de la pestaña". El archivo se guarda localmente en el dispositivo una vez finalizado.';
...
$string['allow_chat'] = 'Permitir chat (interruptor principal global)';
$string['allow_chat_help'] = 'El interruptor principal absoluto para todas las funciones de chat. Si está deshabilitado, toda el área de chat se eliminará para todos, incluidos los moderadores. No será posible el chat público o privado.';
$string['allow_file_upload'] = 'Permitir carga de archivos';
$string['allow_file_upload_help'] = 'Habilita la capacidad de compartir archivos dentro del chat. Esto requiere que el interruptor principal "Permitir chat" esté activo.';

$string['allow_shared_notepad'] = 'Permitir Bloc de notas compartido';
$string['allow_shared_notepad_help'] = 'Habilita un editor de texto colaborativo donde estudiantes y profesores pueden tomar notas en tiempo real juntos. Esto es perfecto para lluvias de ideas, escritura grupal o la creación de un resumen de clase compartido.';
...
$string['allowed_number_rooms'] = 'Número máximo de salas para grupos pequeños';
$string['allowed_number_rooms_help'] = 'El número máximo de sub-salas que un moderador puede crear dentro de una sola sesión.';
$string['preassign_breakout_rooms'] = 'Pre-asigna salas de grupos según los grupos del curso';
$string['preassign_breakout_rooms_help'] = 'Cuando se habilita, cada grupo del curso se convierte en una sala de grupos al inicio de la sesión: el título de la sala es el nombre del grupo y los miembros del grupo se asignan automáticamente a ella. El moderador puede reorganizar o eliminar estas asignaciones en cualquier momento desde la administración de las salas de grupos. Los usuarios que no estén en ningún grupo pueden ser asignados por el moderador durante la sesión. Esto entra en vigor desde el inicio de la siguiente sesión, porque los detalles de la sala se fijan cuando se crea la sala. Requiere que el curso tenga grupos.';

$string['allow_display_external_link_features'] = 'Permitir compartir enlaces externos';
$string['allow_display_external_link_features_help'] = 'Permite a los moderadores mostrar contenido educativo externo, como actividades H5P, paquetes SCORM o sistemas de cuestionarios (p. ej., Kahoot), directamente a todos los participantes durante la sesión.';
...
$string['sip_dial_in_features_is_allow'] = 'Permitir acceso telefónico SIP';
...
$string['insights_features_is_allow'] = 'Permitir análisis de sesión (interruptor principal)';
$string['insights_features_is_allow_help'] = 'El interruptor principal para todas las funciones basadas en datos. Si está deshabilitado, todas las subopciones, incluida la transcripción, el asistente de IA y los informes de reuniones, no estarán disponibles.';
...
$string['insights_ai_features_is_allow'] = 'Permitir asistente de reunión de IA (interruptor principal de IA)';
$string['insights_ai_features_is_allow_help'] = 'El interruptor principal para todas las capacidades impulsadas por IA. Si está deshabilitado, las funciones específicas como el chat de IA y el resumen de reuniones se ocultarán, incluso si el análisis de sesión está activo.';
...
$string['insights_ai_meeting_summarization_features_is_allow_help'] = 'Genera automáticamente un resumen conciso con IA después de que finaliza la sesión, destacando los puntos educativos clave, las decisiones y las tareas de seguimiento.';
...
$string['lock_screen_sharing'] = 'Bloquear compartición de pantalla';
...
$string['lock_reactions'] = 'Bloquear reacciones';
$string['lock_reactions_help'] = 'Impide que los participantes envíen cualquier reacción durante la sesión.';
...
$string['allow_guest_help'] = 'Cuando está habilitado, se genera un enlace compartible seguro para que usuarios externos (como profesores invitados o participantes sin una cuenta de Moodle) puedan unirse a la sesión; un administrador puede ver y compartir este enlace.';
...
$string['room_creation_time'] = 'Hora de Creación de Sesión';
...
$string['analytics_room_recording_status'] = 'Cantidad de estado de grabación';
...
$string['attendance_whiteboard_annotated'] = 'Anotó en la pizarra';
$string['met'] = 'Cumplido';
...
$string['status_conflict'] = 'Esta acción no pudo completarse debido a un conflicto (por ejemplo, la misma petición repetida).';
...
$string['merge_recordings'] = 'Fusiones de grabaciones';
$string['merged_file_name'] = 'Nombre de archivo fusionado';
$string['merge'] = 'Fusión';
$string['close'] = 'Cerrar';
$string['merge_confirmation'] = '¿Estás seguro de que quieres fusionar las grabaciones seleccionadas?';
$string['modal_merge_recordings_header'] = 'Las siguientes grabaciones se fusionarán en este orden:';
$string['modal_merge_recordings_prompt'] = 'Debes seleccionar al menos dos grabaciones para fusionar.';
$string['merge_request_success'] = 'La solicitud de fusión de grabaciones ha sido añadida con éxito. Se te notificará cuando esté completo.';
$string['upload_to_whiteboard'] = 'Subir a la pizarra';
$string['upload_to_whiteboard_success'] = 'Subió con éxito el archivo seleccionado a la pizarra';
$string['uploading_file'] = 'Subiendo archivos...';
$string['file_not_found'] = 'Archivo solicitado no encontrado';
$string['error_file_copy'] = 'Error durante la copia del archivo';

// Create poll from quiz question.
$string['create_poll_from_quiz'] = 'Añadir encuesta desde el cuestionario';
$string['create_poll'] = 'Crear encuesta';
$string['select_quiz'] = 'Seleccionar cuestionario';
$string['select_question'] = 'Seleccione la pregunta';
$string['poll_created'] = 'Encuesta creada con éxito';
$string['poll_creation_failed'] = 'No se pudo crear la encuesta: {$a}';
$string['no_valid_questions'] = 'Este cuestionario no tiene preguntas válidas (solo se admiten preguntas de opción múltiple con una sola respuesta y de verdadero/falso)';
$string['poll_is_anonymous'] = 'Votación anónima';
$string['poll_mode'] = 'Modo de encuesta';
$string['poll_mode_quiz'] = 'Cuestionario (mostrar la respuesta correcta después de la encuesta)';
$string['poll_mode_vote'] = 'Votación (solo recopilar respuestas)';
$string['poll_mode_help'] = 'En el modo cuestionario, los participantes ven la respuesta correcta una vez finalizada la encuesta. En el modo votación, no se muestra ninguna respuesta correcta.';
$string['poll_duration'] = 'Cierre automático después de (minutos)';
$string['poll_duration_help'] = 'Máximo de 60 minutos permitidos. 0 = sin límite';
$string['no_quizzes_found'] = 'No hay cuestionarios en este curso';
$string['room_not_active'] = 'La sala debe estar activa para crear encuestas';
$string['polls_not_allowed'] = 'Las encuestas no están habilitadas para esta sala';
$string['poll_invalid_question'] = 'La pregunta seleccionada no se puede convertir en una encuesta.';
$string['poll_question_tie'] = 'Esta pregunta tiene más de una opción con la misma puntuación más alta y no puede convertirse en una encuesta.';
$string['select_source'] = 'Seleccionar fuente';
$string['source_quiz'] = 'Cuestionario';
...
$string['invalid_question_category'] = 'La categoría de preguntas no existe o no puede utilizarse como fuente de encuesta para esta actividad.';
