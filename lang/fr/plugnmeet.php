...
$string['video_codec_des'] = 'La norme d’encodage pour la transmission vidéo. **VP9** est la norme par défaut et recommandée pour WebRTC, offrant un meilleur équilibre entre qualité vidéo, efficacité CPU et faible latence (revenant automatiquement à **VP8** sur les navigateurs plus anciens). **Avertissement :** Les codecs avancés comme AV1 ou H.265 nécessitent un support moderne des navigateurs ; Assurez-vous que vos utilisateurs sont sur des configurations compatibles si vous vous écartez des paramètres par défaut.';
...
$string['recording_broadcasting_features'] = 'Enregistrement et diffusion';
...
$string['allow_broadcasting'] = 'Autoriser la diffusion (commutateur maître)';
$string['allow_broadcasting_help'] = 'Le commutateur principal principal pour toutes les fonctionnalités de diffusion. Si désactivées, toutes les autres options de diffusion seront désactivées.';
...
$string['allow_reactions'] = 'Autoriser les réactions';
$string['allow_reactions_help'] = 'Permettre aux participants d’envoyer des réactions flottantes (par exemple, pouce levé, applaudissement) pendant la séance.';
...
$string['only_record_admin_webcams'] = 'Seules webcams d’administration des dossiers';
$string['only_record_admin_webcams_help'] = 'Si activé, seules les webcams des administrateurs seront incluses dans l’enregistrement.';
...
$string['lock_reactions'] = 'Réactions de verrouillage';
$string['lock_reactions_help'] = 'Empêche les participants d’envoyer des réactions pendant la séance.';
...
$string['analytics_room_shared_notepad_status'] = 'Nombre de statuts du bloc-notes';
...
$string['status_conflict'] = 'Cette action n’a pas pu être accomplie en raison d’un conflit (par exemple, la même demande répétée).';
...
$string['merge_recordings'] = 'Fusion des enregistrements';
$string['merged_file_name'] = 'Nom de fichier fusionné';
$string['merge'] = 'Fusion';
$string['close'] = 'Fermer';
$string['merge_confirmation'] = 'Êtes-vous sûr de vouloir fusionner les enregistrements sélectionnés ?';
$string['modal_merge_recordings_header'] = 'Les enregistrements suivants seront fusionnés dans cet ordre :';
$string['modal_merge_recordings_prompt'] = 'Vous devez sélectionner au moins deux enregistrements pour fusionner.';
$string['merge_request_success'] = 'La demande de fusion d’enregistrements a été ajoutée avec succès. Vous serez informé lorsque ce sera terminé.';
$string['upload_to_whiteboard'] = 'Téléverser sur le tableau blanc';
$string['upload_to_whiteboard_success'] = 'Téléversement réussi le fichier sélectionné sur le tableau blanc';
...
$string['poll_mode'] = 'Mode de sondage';
$string['poll_mode_quiz'] = 'Quiz (montrer la bonne réponse après le sondage)';
$string['poll_mode_vote'] = 'Votez (collectez uniquement les réponses)';
$string['poll_mode_help'] = 'En mode quiz, les participants voient la bonne réponse après la fin du sondage. En mode vote, aucune bonne réponse n’est affichée.';
$string['poll_duration'] = 'Fermeture automatique après (minutes)';
$string['poll_duration_help'] = 'Maximum de 60 minutes autorisées. 0 = pas de limite';
