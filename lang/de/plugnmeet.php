...
$string['video_codec_des'] = 'Der Codierungsstandard für die Videoübertragung. **VP9** ist der Standard- und empfohlene Standard für WebRTC und bietet eine überlegene Balance zwischen Videoqualität, CPU-Effizienz und niedriger Latenz (bei älteren Browsern fällt er automatisch auf **VP8** zurück). **Warnung:** Fortgeschrittene Codecs wie AV1 oder H.265 benötigen moderne Browser-Unterstützung; Stelle sicher, dass deine Nutzer kompatible Setups haben, falls du vom Standard abweichst.';
...
$string['recording_broadcasting_features'] = 'Aufnahme und Übertragung';
...
$string['allow_broadcasting'] = 'Übertragung erlauben (Master-Schalter)';
$string['allow_broadcasting_help'] = 'Der primäre Hauptschalter für alle Rundfunkfunktionen. Wenn deaktiviert, werden alle anderen Übertragungsoptionen deaktiviert.';
...
$string['allow_reactions'] = 'Erlauben Sie Reaktionen';
$string['allow_reactions_help'] = 'Erlauben Sie den Teilnehmern, während der Sitzung schwebende Reaktionen (z. B. Daumen hoch, Klatschen) zu senden.';
...
$string['only_record_admin_webcams'] = 'Nur Admin-Webcams aufnehmen';
$string['only_record_admin_webcams_help'] = 'Wenn aktiviert, werden nur die Webcams der Administratoren in die Aufzeichnung einbezogen.';
...
$string['lock_reactions'] = 'Schlossreaktionen';
$string['lock_reactions_help'] = 'Verhindert, dass Teilnehmer während der Sitzung irgendwelche Reaktionen senden.';
...
$string['analytics_room_shared_notepad_status'] = 'Notepad-Statuszählung';
...
$string['status_conflict'] = 'Diese Aktion konnte wegen eines Konflikts (z. B. wiederholter Wunsch) nicht ausgeführt werden.';
...
$string['merge_recordings'] = 'Zusammenführungsaufnahmen';
$string['merged_file_name'] = 'Zusammengeführter Dateiname';
$string['merge'] = 'Zusammenführung';
$string['close'] = 'Schließen';
$string['merge_confirmation'] = 'Bist du sicher, dass du die ausgewählten Aufnahmen zusammenführen möchtest?';
$string['modal_merge_recordings_header'] = 'Die folgenden Aufnahmen werden in folgender Reihenfolge zusammengeführt:';
$string['modal_merge_recordings_prompt'] = 'Sie müssen mindestens zwei Aufnahmen zum Zusammenführen auswählen.';
$string['merge_request_success'] = 'Die Anfrage zum Zusammenführen der Aufnahmen wurde erfolgreich hinzugefügt. Sie werden benachrichtigt, sobald es abgeschlossen ist.';
$string['upload_to_whiteboard'] = 'Auf das Whiteboard hochladen';
$string['upload_to_whiteboard_success'] = 'Ausgewählte Datei erfolgreich auf das Whiteboard hochgeladen';
...
$string['poll_mode'] = 'Umfragemodus';
$string['poll_mode_quiz'] = 'Quiz (korrekte Antwort nach der Umfrage anzeigen)';
$string['poll_mode_vote'] = 'Abstimmen (nur Antworten sammeln)';
$string['poll_mode_help'] = 'Im Quiz-Modus sehen die Teilnehmer nach Ende der Umfrage die richtige Antwort. Im Abstimmungsmodus wird keine richtige Antwort angezeigt.';
$string['poll_duration'] = 'Automatisches Schließen nach (Minuten)';
$string['poll_duration_help'] = 'Maximal 60 Minuten erlaubt. 0 = kein Limit';
