...
$string['preload_file'] = 'ملف العرض المسبق';
$string['preload_file_help'] = 'يسمح لك برفع ملف PDF أو مستند أوفيس سيتم تحميله تلقائيا على السبورة عند بدء الجلسة. هذا يضمن أن مادة العرض التقديمي جاهزة للصف فورا. <strong>الحد الأقصى لحجم الملف: 5 ميجابايت</strong>';
