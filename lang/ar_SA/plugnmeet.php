...
$string['enable_end_to_end_encryption_features_help'] = 'يوفر أمانا قويا من خلال تشفير تدفقات الفيديو والصوت بين المشاركين. في هذا الوضع، يولد الخادم ويقوم بتوزيع مفتاح تشفير فريد للجلسة بشكل آمن.';
$string['enabled_self_insert_encryption_key'] = 'السماح بالمفاتيح التي يحددها المشاركون';
$string['enabled_self_insert_encryption_key_help'] = 'يسمح للمشاركين بإدخال مفتاح سري مشترك يدويا، مما يوفر أعلى مستوى من الخصوصية لأن الخادم لا يملك أبدا وصول إلى مفاتيح التشفير. تقع على عاتق المضيف مسؤولية مشاركة نفس السر مع جميع المشاركين؛ إذا تم استخدام مفاتيح مختلفة، فلن يتمكن المستخدمون من التواصل مع بعضهم البعض. <strong>ملاحظة:</strong> عند تفعيل هذا الخيار، سيتم تعطيل الميزات التي تتطلب معالجة وسائط على جانب الخادم (مثل التسجيل السحابي، النسخ، والتلخيص بالذكاء الاصطناعي) تلقائيا.';
...
$string['client_connection_error'] = 'حدث خطأ في الاتصال بخادم PlugNmet: {$a}. يرجى التحقق من إعدادات الإضافات الخاصة بك.';
