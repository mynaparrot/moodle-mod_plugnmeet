...
$string['video_codec_des'] = 'O padrão de codificação para transmissão de vídeo. **VP9** é o padrão padrão e recomendado para o WebRTC, oferecendo um equilíbrio superior entre qualidade de vídeo, eficiência do CPU e baixa latência (recorrendo automaticamente a **VP8** em navegadores mais antigos). **Aviso:** Codecs avançados como AV1 ou H.265 requerem suporte moderno para navegadores; Certifique-se de que os seus utilizadores estão em configurações compatíveis se se desviar do padrão.';
...
$string['recording_broadcasting_features'] = 'Gravação e Transmissão';
...
$string['allow_broadcasting'] = 'Permitir Transmissão (Master Switch)';
$string['allow_broadcasting_help'] = 'O principal interruptor mestre para todas as funcionalidades de transmissão. Se desativado, todas as outras opções de transmissão serão desativadas.';
...
$string['allow_reactions'] = 'Permitir Reações';
$string['allow_reactions_help'] = 'Permitir que os participantes enviem reações flutuantes (por exemplo, polegar para cima, palmas) durante a sessão.';
...
$string['only_record_admin_webcams'] = 'Apenas Webcams de Administrador de Registos';
$string['only_record_admin_webcams_help'] = 'Se ativado, apenas as webcams dos administradores serão incluídas na gravação.';
...
$string['lock_reactions'] = 'Reações das Fechaduras';
$string['lock_reactions_help'] = 'Impede que os participantes enviem quaisquer reações durante a sessão.';
...
$string['analytics_room_shared_notepad_status'] = 'Contagem de Estado do Bloco de Notas';
...
$string['status_conflict'] = 'Esta ação não pôde ser concluída devido a um conflito (por exemplo, o mesmo pedido repetido).';
...
$string['merge_recordings'] = 'Gravações de Fusão';
$string['merged_file_name'] = 'Nome de ficheiro fundido';
$string['merge'] = 'Fusão';
$string['close'] = 'Fechar';
$string['merge_confirmation'] = 'Tens a certeza de que queres fundir as gravações selecionadas?';
$string['modal_merge_recordings_header'] = 'As seguintes gravações serão fundidas nesta ordem:';
$string['modal_merge_recordings_prompt'] = 'Deve selecionar pelo menos duas gravações para fundir.';
$string['merge_request_success'] = 'O pedido de fusão de gravações foi adicionado com sucesso. Será notificado quando estiver concluído.';
$string['upload_to_whiteboard'] = 'Carregar para o Quadro Branco';
$string['upload_to_whiteboard_success'] = 'Carreguei com sucesso o ficheiro selecionado para o quadro branco';
...
$string['poll_mode'] = 'Modo de votação';
$string['poll_mode_quiz'] = 'Quiz (mostrar a resposta correta após a votação)';
$string['poll_mode_vote'] = 'Votar (apenas recolher respostas)';
$string['poll_mode_help'] = 'No modo questionário, os participantes veem a resposta correta após o fim da votação. No modo de votação, não é mostrada nenhuma resposta correta.';
$string['poll_duration'] = 'Fecho automático após (minutos)';
$string['poll_duration_help'] = 'Máximo de 60 minutos permitidos. 0 = sem limite';
