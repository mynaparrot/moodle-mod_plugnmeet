...
$string['room_duration_help'] = 'Максимальная продолжительность в комнате за несколько минут. 0 — без лимита.';
...
$string['auto_gen_user_id_help'] = 'Автоматически сгенерируйте идентификатор пользователя для каждого участника.';
...
$string['allow_guest_help'] = 'Разрешите внешним пользователям без аккаунта Moodle присоединяться к сессии через ссылку, которую можно поделиться.';
