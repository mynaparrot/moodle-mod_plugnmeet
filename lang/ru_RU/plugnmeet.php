...
$string['preload_file'] = 'Файл предзагрузки презентации';
$string['preload_file_help'] = 'Позволяет загружать PDF или документ Office, который автоматически загружается на доску при начале сессии. Это гарантирует, что материал презентации будет готов для занятия сразу же. <strong>Максимальный размер файла: 5 Мб</strong>';
