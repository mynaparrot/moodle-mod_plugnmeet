...
$string['video_codec_des'] = '视频传输的编码标准。**VP9** 是 WebRTC 的默认且推荐的标准，在视频质量、CPU 效率和低延迟之间提供了优越的平衡（在旧浏览器中会自动退回 **VP8**）。**警告：** 高级编解码器如AV1或H.265需要现代浏览器支持;如果你偏离默认设置，确保用户使用的是兼容的。';
...
$string['recording_broadcasting_features'] = '录音与广播';
...
$string['allow_broadcasting'] = '允许广播（主交换机）';
$string['allow_broadcasting_help'] = '所有广播功能的主交换机。如果被禁用，所有其他广播选项都会被禁用。';
...
$string['allow_reactions'] = '允许反应';
$string['allow_reactions_help'] = '允许参与者在课程中发送浮动反应（例如竖起大拇指、拍手）。';
...
$string['only_record_admin_webcams'] = '仅录制管理员摄像头';
$string['only_record_admin_webcams_help'] = '如果启用，只有管理员的摄像头会被包含在录制中。';
...
$string['enable_end_to_end_encryption_features_help'] = '通过加密参与者之间的视频和音频流，提供强有力的安全保障。在此模式下，服务器生成并安全分发会话的唯一加密密钥。';
$string['enabled_self_insert_encryption_key'] = '允许参与者自定义密钥';
$string['enabled_self_insert_encryption_key_help'] = '允许参与者手动输入共享密钥，提供最高级别的隐私保护，因为服务器永远无法访问加密密钥。主持人有责任与所有参与者分享同一个秘密;如果使用不同的密钥，用户之间将无法通信。 <strong>注：</strong> 启用此选项后，需要服务器端媒体处理的功能（如云录制、转录和AI摘要）将自动被禁用。';
...
$string['lock_reactions'] = '锁反应';
$string['lock_reactions_help'] = '防止参与者在会话中发送任何反应。';
...
$string['client_connection_error'] = '连接 PlugNmeet 服务器时出现了错误： {$a}.请检查你的插件设置。';
...
$string['analytics_room_shared_notepad_status'] = '记事本状态计数';
...
$string['status_conflict'] = '由于冲突（例如，同一请求重复），该操作无法完成。';
...
$string['merge_recordings'] = '合并录音';
$string['merged_file_name'] = '合并文件名';
$string['merge'] = '合并';
$string['close'] = '结束';
$string['merge_confirmation'] = '你确定要合并所选录音吗？';
$string['modal_merge_recordings_header'] = '以下录音将按顺序合并：';
$string['modal_merge_recordings_prompt'] = '你必须至少选择两个录音进行合并。';
$string['merge_request_success'] = '录音合并请求已成功添加。完成后会通知您。';
$string['upload_to_whiteboard'] = '上传到白板';
$string['upload_to_whiteboard_success'] = '已成功上传选定文件到白板';
...
$string['poll_mode'] = '轮询模式';
$string['poll_mode_quiz'] = '测验（投票后显示正确答案）';
$string['poll_mode_vote'] = '投票（仅收集回复）';
$string['poll_mode_help'] = '在测验模式下，参与者在投票结束后看到正确答案。投票模式下，不会显示正确答案。';
$string['poll_duration'] = '自动关闭时间（分钟）';
$string['poll_duration_help'] = '最多允许60分钟。0 = 无限制';
