...
$string['pluginadministration'] = 'Адміністрування PlugNmeet';
...
$string['subplugintype_pnmext'] = 'Розширення PlugNmeet';
$string['subplugintype_pnmext_plural'] = 'Розширення PlugNmeet';
...
$string['video_codec_des'] = 'Стандарт кодування для передачі відео. **VP9** є стандартом за замовчуванням і рекомендованим для WebRTC, який пропонує кращий баланс якості відео, ефективності процесора та низької затримки (автоматично повертається до **VP8** у старіших браузерах). **Увага:** Просунуті кодеки, такі як AV1 або H.265, потребують підтримки сучасних браузерів; Переконайтеся, що ваші користувачі на сумісних налаштуваннях, якщо ви відхиляєтеся від стандартних.';
...
$string['recording_broadcasting_features'] = 'Запис і трансляція';
...
$string['allow_broadcasting'] = 'Дозволити трансляцію (головний комутатор)';
$string['allow_broadcasting_help'] = 'Основний головний комутатор для всіх функцій мовлення. Якщо вимкнено, всі інші опції трансляції будуть вимкнені.';
...
$string['allow_reactions'] = 'Дозволити реакції';
$string['allow_reactions_help'] = 'Дозвольте учасникам надсилати плаваючі реакції (наприклад, великий палець вгору, плескати) під час сесії.';
...
$string['only_record_admin_webcams'] = 'Лише вебкамери адміністратора записів';
$string['only_record_admin_webcams_help'] = 'Якщо увімкнено, у запис будуть включені лише вебкамери адміністраторів.';
...
$string['preassign_breakout_rooms'] = 'Заздалегідь призначте кімнати для груп курсів';
$string['preassign_breakout_rooms_help'] = 'При увімкненні кожна група курсу стає секційною кімнатою на початку сесії: назва кімнати — це назва групи, і члени групи автоматично призначаються в неї. Модератор може у будь-який момент змінити або видалити ці завдання в режимі управління секційною кімнатою зустрічі. Користувачі, які не входять до жодної групи, можуть бути призначені модератором під час сесії. Це набирає чинності з початку наступної сесії, оскільки деталі кімнати виправляються під час створення кімнати. Вимагає наявності груп у курсі.';
...
$string['enable_end_to_end_encryption_features_help'] = 'Забезпечує потужний захист шляхом шифрування відео- та аудіопотоків між учасниками. У цьому режимі сервер генерує та безпечно розподіляє унікальний ключ шифрування для сесії.';
$string['enabled_self_insert_encryption_key'] = 'Дозволити ключі, визначені учасниками';
$string['enabled_self_insert_encryption_key_help'] = 'Дозволяє учасникам вручну вводити спільний секретний ключ, забезпечуючи найвищий рівень конфіденційності, оскільки сервер ніколи не має доступу до ключів шифрування. Відповідальність ведучого — поділитися однією таємницею з усіма учасниками; якщо використовуються різні ключі, користувачі не зможуть спілкуватися між собою. <strong>Примітка:</strong> Коли ця опція увімкнена, функції, що потребують серверної обробки медіа (наприклад, хмарний запис, транскрипція та узагальнення за допомогою ШІ), автоматично вимикаються.';
...
$string['lock_reactions'] = 'Реакції замків';
$string['lock_reactions_help'] = 'Не дозволяє учасникам надсилати будь-які реакції під час сесії.';
...
$string['client_files_missing'] = 'Клієнтські файли (JS/CSS) відсутні. Будь ласка, перевірте конфігурацію сервера PlugNmet.';
$string['client_connection_error'] = 'Виникла помилка підключення до сервера PlugNmet: {$a}. Будь ласка, перевірте налаштування плагіна.';
...
$string['created_at'] = 'Створено в';
$string['meeting_summary'] = 'Підсумок зустрічі';
$string['error_loading_meeting_summary'] = 'Резюме засідання при завантаженні помилки: {$a}';
...
$string['status_conflict'] = 'Цю дію не вдалося виконати через конфлікт (наприклад, повторення одного й того ж запиту).';
...
$string['merge_recordings'] = 'Merge Recordings';
$string['merged_file_name'] = 'Об\'єднана назва файлу';
$string['merge'] = 'Злиття';
$string['close'] = 'Закриття';
$string['merge_confirmation'] = 'Ви впевнені, що хочете об\'єднати вибрані записи?';
$string['modal_merge_recordings_header'] = 'Наступні записи будуть об\'єднані в такому порядку:';
$string['modal_merge_recordings_prompt'] = 'Ви повинні обрати щонайменше два записи для об\'єднання.';
$string['merge_request_success'] = 'Запит на злиття записів успішно додано. Ви отримаєте сповіщення, коли вона буде завершена.';
$string['upload_to_whiteboard'] = 'Завантаження на дошку';
$string['upload_to_whiteboard_success'] = 'Успішно завантажено вибраний файл на дошку';
...
$string['poll_mode'] = 'Режим опитування';
$string['poll_mode_quiz'] = 'Вікторина (показати правильну відповідь після опитування)';
$string['poll_mode_vote'] = 'Голосуйте (збирайте лише відповіді)';
$string['poll_mode_help'] = 'У режимі вікторини учасники бачать правильну відповідь після завершення опитування. У режимі голосування правильна відповідь не відображається.';
$string['poll_duration'] = 'Автоматичне закриття після (за кілька хвилин)';
$string['poll_duration_help'] = 'Максимум дозволено 60 хвилин. 0 = без обмежень';
