...
$string['enable_end_to_end_encryption_features_help'] = 'Bietet starke Sicherheit durch Verschlüsselung von Video- und Audioströmen zwischen den Teilnehmern. In diesem Modus erzeugt und verteilt der Server sicher einen eindeutigen Verschlüsselungsschlüssel für die Sitzung.';
$string['enabled_self_insert_encryption_key'] = 'Teilnehmerdefinierte Tasten zulassen';
$string['enabled_self_insert_encryption_key_help'] = 'Ermöglicht es den Teilnehmern, einen gemeinsamen geheimen Schlüssel manuell einzugeben, was das höchste Maß an Privatsphäre bietet, da der Server nie Zugriff auf die Verschlüsselungsschlüssel hat. Es ist die Verantwortung des Gastgebers, dasselbe Geheimnis mit allen Teilnehmern zu teilen; Wenn verschiedene Schlüssel verwendet werden, können Nutzer nicht miteinander kommunizieren. <strong>Hinweis:</strong> Wenn diese Option aktiviert ist, werden Funktionen, die serverseitige Medienverarbeitung erfordern (wie Cloud-Aufzeichnung, Transkription und KI-Zusammenfassung), automatisch deaktiviert.';
...
$string['client_files_missing'] = 'Clientdateien (JS/CSS) fehlen. Bitte überprüfen Sie Ihre PlugNmeet-Serverkonfiguration.';
$string['client_connection_error'] = 'Es gab einen Fehler in Verbindung mit dem PlugNmeet-Server: {$a}. Bitte überprüfe deine Plugin-Einstellungen.';
