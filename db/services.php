...
$functions = [
    ...
    'mod_plugnmeet_get_course_quizzes' => [
        'classname'   => 'mod_plugnmeet\external\get_course_quizzes',
        'methodname'  => 'execute',
        'description' => 'Gets the quizzes of the course of a plugNmeet activity.',
        'type'        => 'read',
        'ajax'        => true,
        'capability'  => 'mod/plugnmeet:manage',
    ],
    'mod_plugnmeet_get_quiz_questions' => [
        'classname'   => 'mod_plugnmeet\external\get_quiz_questions',
        'methodname'  => 'execute',
        'description' => 'Get valid quiz questions for poll conversion.',
        'type'        => 'read',
        'ajax'        => true,
        'capability'  => 'mod/plugnmeet:manage',
    ],
    'mod_plugnmeet_get_question_categories' => [
        'classname'   => 'mod_plugnmeet\external\get_question_categories',
        'methodname'  => 'execute',
        'description' => 'Get the question categories that can be used as a poll source.',
        'type'        => 'read',
        'ajax'        => true,
        'capability'  => 'mod/plugnmeet:manage',
    ],
    'mod_plugnmeet_create_poll' => [
        'classname'   => 'mod_plugnmeet\external\create_poll',
        'methodname'  => 'execute',
        'description' => 'Create a poll from a Moodle quiz question.',
        'type'        => 'write',
        'ajax'        => true,
        'capability'  => 'mod/plugnmeet:manage',
    ],
